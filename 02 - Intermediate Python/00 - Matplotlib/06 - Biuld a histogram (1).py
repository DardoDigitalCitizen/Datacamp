"""
life_exp, the list containing data on the life expectancy for different countries in 2007, is available in your Python.
...
# the number of bins to 10 by default for you.
plt.hist(life_exp)
plt.show() # . Can you tell which bin contains the most observations?