...
"""
# height (in inches - in) and weight (in pounds - lbs)  are available as regular lists
...
# Create a numpy array from the weight_lb list with the correct units. Multiply by 0.453592 to go from pounds
# to kilograms. Store the resulting numpy array as np_weight_kg.
